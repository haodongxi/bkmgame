...
const ITEMS = {
  ...
  '重生药': { id: 'rebirth_potion', name: '重生药', type: 'retalent', price: 200000, minBadges: 8, desc: '重置并随机一只宝可梦的六项个体值（天赋）' },
  ...
  '剩饭盒':   { id: 'leftovers_box', name: '剩饭盒', type: 'held', held: '剩饭盒', onlySpecies: 143, desc: '卡比兽的专属道具，携带后每回合结束恢复 1/16 最大HP' },
  '不灭之种': { id: 'undying_seed', name: '不灭之种', type: 'held', held: '不灭之种', onlySpecies: 6, desc: '喷火龙的专属道具，携带后火系招式威力 +50%' },
  '涡轮喷口': { id: 'turbo_nozzle', name: '涡轮喷口', type: 'held', held: '涡轮喷口', onlySpecies: 9, desc: '水箭龟的专属道具，携带后水系招式威力 +50%' },
  '快龙之鳞': { id: 'dragon_scale', name: '快龙之鳞', type: 'held', held: '快龙之鳞', onlySpecies: 149, desc: '快龙的专属道具，携带后龙系招式威力 +50%' },
  '秘传之眼': { id: 'mystic_eye', name: '秘传之眼', type: 'held', held: '秘传之眼', onlySpecies: 121, desc: '宝石海星的专属道具，携带后超能力系招式必中且暴击率翻倍' },
  '心灵汤勺': { id: 'psy_spoon', name: '心灵汤勺', type: 'held', held: '心灵汤勺', onlySpecies: 65, desc: '胡地的专属道具，携带后特攻 +30%' },
  ...
  '珍珠泪':   { id: 'pearl_tear', name: '珍珠泪', type: 'held', held: '珍珠泪', onlySpecies: 91, desc: '刺甲贝的专属道具，携带后冰系招式威力 +50%' },
  '锐利镰刀': { id: 'scythe_blade', name: '锐利镰刀', type: 'held', held: '锐利镰刀', onlySpecies: 123, desc: '飞天螳螂的专属道具，携带后虫系招式威力 +50%' },
  '剧毒针':   { id: 'venom_needle', name: '剧毒针', type: 'held', held: '剧毒针', onlySpecies: 15, desc: '大针蜂的专属道具，携带后毒系招式威力 +50%' },
  '愤怒之角': { id: 'rage_horn', name: '愤怒之角', type: 'held', held: '愤怒之角', onlySpecies: 128, desc: '肯泰罗的专属道具，携带后普通系招式威力 +50%' },
  '幸运葱':   { id: 'lucky_leek', name: '幸运葱', type: 'held', held: '幸运葱', onlySpecies: 83, desc: '大葱鸭的专属道具，携带后攻击招式必中且暴击率翻倍' },
  '远古之翼': { id: 'ancient_wing', name: '远古之翼', type: 'held', held: '远古之翼', onlySpecies: 142, desc: '化石翼龙的专属道具，携带后飞行系招式威力 +50%' },
