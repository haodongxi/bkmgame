...
const TEMPLATES = {
  ...
  '电': { 1: ['thundershock', 'growl'], 10: ['quick_attack'], 20: ['thunderbolt'], 30: ['thunder_wave'], 40: ['swift'], 50: ['thunder'] },
  '普通': { 1: ['tackle', 'growl'], 10: ['quick_attack'], 20: ['take_down'], 30: ['swords_dance'], 40: ['double_edge'], 50: ['hyper_beam'] },
  '飞行': { 1: ['peck', 'growl'], 10: ['gust'], 20: ['wing_attack'], 30: ['aerial_ace'], 40: ['drill_peck'], 50: ['hyper_beam'] },
  ...
  '超能力': { 1: ['confusion', 'growl'], 10: ['psybeam'], 20: ['psychic'], 30: ['calm_mind'], 40: ['recover'], 50: ['hyper_beam'] },
  '幽灵': { 1: ['lick', 'growl'], 10: ['night_shade'], 20: ['shadow_ball'], 30: ['confuse_ray'], 40: ['dream_eater'], 50: ['hyper_beam'] },
  '冰': { 1: ['tackle', 'growl'], 10: ['ice_beam'], 20: ['blizzard'], 30: ['ice_punch'], 40: ['aurora_beam'], 50: ['hyper_beam'] },
